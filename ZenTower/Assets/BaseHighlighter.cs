	...
	public abstract class BaseHighlighter : MonoBehaviour
	{
		...
		public static BaseHighlighter GetActiveHighlighter(GameObject obj)
		{
			BaseHighlighter objectHighlighter = null;
			foreach (var tmpHighlighter in obj.GetComponents<BaseHighlighter>())
			{
